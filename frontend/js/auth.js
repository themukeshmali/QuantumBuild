...
// API_BASE is defined in api-client.js (loaded first)
// ============================================
...
async function fetchWithAuth(url, options = {}) {
    ...
    if (response.status === 401) {
        clearUserInfo();
        // Use absolute path so redirect works from ANY page depth (e.g. /frontend/order-detail.html)
        const loginUrl = '/frontend/login.html?redirect=' + encodeURIComponent(window.location.pathname + window.location.search);
